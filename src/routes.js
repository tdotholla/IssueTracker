  ...
  apply(routeHandler) {
    ...
    routeHandler.hooks.initRoutes.tapPromise("AppRoutes", async () => {
      ...
      routeHandler.setPwaSchema({
        ...
        theme_color: "#111",
        display: "standalone",
        description: "Tracking the I18N Inventory",
        icons: [
          {
            src: ShareImg72,
            sizes: "72x72"
      ...
      routeHandler.getDefaultSeoSchema = () => ({
        title: "I18n Issue Tracker",
        name: "I18n Issue Tracker",
        description: "Tracking the I18N Inventory",
        type: "website",
        url: "kielbyrne.com/i18nIT",
        site_name: "i18nIT",
        ...
        meta: [
          ...
          {
            name: "description",
            content: "Tracking the I18N Inventory"
          },
          {
            name: "theme-color",
            content: "#111"
